...
public class TianmiaoRefreshHeaderView extends RelativeLayout implements SwipeTrigger, SwipeRefreshTrigger {
    ...
    public TianmiaoRefreshHeaderView(Context context) {
        this(context, null);
    }

    public TianmiaoRefreshHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TianmiaoRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
