package com.qingshangzuo.smartrefreshlayout.view;
 ...
 * 菜谱刷新
 */
public class ElmRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    public ElmRefreshHeaderView(Context context) {
        this(context, null);
    }

    public ElmRefreshHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ElmRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onPrepare() {
        Log.d("ElmRefreshHeaderView", "onPrepare()");
    }
    ...
    public void onRelease() {
        Log.d("ElmRefreshHeaderView", "onRelease()");
    }
